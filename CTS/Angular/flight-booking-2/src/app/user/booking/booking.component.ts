...
export class BookingComponent implements OnInit {
  ...
  saveBooking(){
    let booking = new SaveBooking(this.id,this.name, this.mobile, this.email,this.password,this.trip,this.fromplace,this.toplace,this.onworddate,this.returndate,this.persons,this.total,this.airlineid)
