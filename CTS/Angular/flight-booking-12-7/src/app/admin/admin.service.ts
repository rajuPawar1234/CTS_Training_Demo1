...
private baseUrl1 = 'http://localhost:8082/flight-booking-admin/airline';
  ...
  updateFlight(airlineid : number,flight : Flights){
    return this.http.put("http://localhost:8082/flight-booking-admin/airline/"+airlineid,flight);
  }

  getFlightDetail(airlineid : number) {
    return this.http.get<any>("http://localhost:8082/flight-booking-admin/airline/"+airlineid);
  }
  ...
  updateFlightSchedule(id : number,airlineSchedule : AirlineSchedule){
    return this.http.put("http://localhost:8082/flight-booking-admin/airlineshedule/"+id,airlineSchedule);
  }
  ...
  getFlightScheduleFromTo(fromP : string,toP : string){
    ...
    return this.http.get<any>("http://localhost:8082/flight-booking-admin/getFlightSchedule?fromP="+fromP+"&toP="+toP);
  }
  ...
  updateDiscount(id : number,dis : Discount){
    return this.http.put("http://localhost:8082/flight-booking-admin/discount/"+id,dis);
  }
