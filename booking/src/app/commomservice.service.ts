...
export class CommomserviceService {
 ...
 clickWelcome(){
  ...
  getAllSchedule(){
    return this.http.get<any>("http://localhost:3000/airlineschedule");
  }

  addFlightSchedule(airlineschedule : AirlineSchedule){
    return this.http.post("http://localhost:3000/airlineschedule",airlineschedule);
  }

  deleteSchedule(id : number){
    return this.http.delete("http://localhost:3000/airlineschedule/"+id);
  }
  ...
  addDiscount(dis : Discount){
    return this.http.post("http://localhost:3000/discount",dis);
  }

  getAllDiscount(){
    return this.http.get<any>("http://localhost:3000/discount");
  }
